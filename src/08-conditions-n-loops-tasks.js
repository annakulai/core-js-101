...
function doRectanglesOverlap(rect1, rect2) {
  if (rect1.width < rect2.top || rect1.height < rect2.left) return false;
  return true;
}
...
function isInsideCircle(circle, point) {
  ...
  if (circle.radius ** 2 > x + y) return true;
  return false;
}
...
function getIntervalString(a, b, isStartIncluded, isEndIncluded) {
  ...
  if (a > b) {
    return `${startSign}${b}, ${a}${endSign}`;
  }
  return `${startSign}${a}, ${b}${endSign}`;
}
